...
func TestScrapeExcludesTheMissingStreams(t *testing.T) {
	t.Parallel()

	t.Run("isolates missing log stream", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("counts missing stream once", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("bounds isolation calls", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("keeps isolating when a half fails for another reason", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("isolates each batch independently", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("attributes rejections when time runs out", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("leaves batches for the next scrape when time runs out", func(t *testing.T) {
		t.Parallel()
...
func TestScrapeReleasesTheStreamsThatCameBack(t *testing.T) {
	t.Parallel()

	t.Run("reprobes missing stream", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("stops excluding silent stream", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("stops excluding stream answered before a page failed", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("clears missing stream when monitoring is disabled", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("clears missing stream on resource ID change", func(t *testing.T) {
		t.Parallel()
...
func TestScrapeSpreadsTheProbesAcrossScrapes(t *testing.T) {
	t.Parallel()

	t.Run("spends one probe slot per log stream", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("probes every missing stream across scrapes", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("staggers probes across scrapes", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("converges with more missing streams than probe slots", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("keeps healthy instances reporting across probe cycles", func(t *testing.T) {
		t.Parallel()
...
func TestScrapeKeepsWhatItCollected(t *testing.T) {
	t.Parallel()

	t.Run("keeps streams on recoverable error", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("keeps partial results", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("batches streams", func(t *testing.T) {
		t.Parallel()
...
func TestMaxIsolationCalls(t *testing.T) {
	t.Parallel()
	...
	// stream singled out.
	t.Run("attributes a full batch", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("covers the probe rate", func(t *testing.T) {
		t.Parallel()
...
func TestMissingStreams(t *testing.T) {
	...
	t.Run("marks, confirms and leaves an exclusion alone", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("releases the tentative exclusions", func(t *testing.T) {
		t.Parallel()
